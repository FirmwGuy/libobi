...
#define OBI_TEXT_PROVIDER_ID "obi.provider:text.ime.gtk"
#define OBI_TEXT_PROVIDER_DEPS_JSON "[{\"name\":\"GTK\"}]"
#define OBI_TEXT_PROVIDER_SPDX "LGPL-2.1-or-later"
#define OBI_TEXT_PROVIDER_LICENSE_CLASS "weak_copyleft"
#define OBI_TEXT_PROVIDER_PROFILES_JSON "[\"obi.profile:text.ime-0\"]"
