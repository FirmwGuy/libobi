...
static obi_status _describe_legal_metadata(void* ctx,
    ...
    out_meta->effective_license.spdx_expression = "MPL-2.0 AND Unlicense";
    out_meta->effective_license.summary_utf8 =
        "Effective posture reflects module plus required LibTomMath dependency";
