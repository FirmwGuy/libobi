...
static const char* _describe_json(void* ctx) {
    (void)ctx;
    return "{\"provider_id\":\"obi.provider:media.image\",\"provider_version\":\"0.1.0\","
...
static obi_status _describe_legal_metadata(void* ctx,
    ...
    static const obi_legal_dependency_v0 deps[] = {
        {
            ...
            .legal = {
                ...
                .summary_utf8 = "libjpeg variant/license may differ by platform distribution",
            },
        },
        {
            .struct_size = (uint32_t)sizeof(obi_legal_dependency_v0),
            .relation = OBI_LEGAL_DEP_REQUIRED_RUNTIME,
            .dependency_id = "libpng",
            .name = "libpng",
            .version = "dynamic",
            .legal = {
                .struct_size = (uint32_t)sizeof(obi_legal_term_v0),
                ...
                .spdx_expression = "libpng-2.0",
            },
        },
        {
            .struct_size = (uint32_t)sizeof(obi_legal_dependency_v0),
            .relation = OBI_LEGAL_DEP_REQUIRED_RUNTIME,
            .dependency_id = "libwebp",
            .name = "libwebp",
            .version = "dynamic",
            .legal = {
                .struct_size = (uint32_t)sizeof(obi_legal_term_v0),
    ...
    out_meta->effective_license.summary_utf8 =
        "Effective posture is conservative unknown due unresolved libjpeg distribution/license variance";
