...
static obi_status _describe_legal_metadata(void* ctx,
    ...
    static const obi_legal_dependency_v0 deps[] = {
        {
            ...
            .legal = {
                ...
                .spdx_expression = "AFL-2.1 OR GPL-2.0-or-later",
                .summary_utf8 = "Conservative posture for multi-license dependency expression",
            },
        },
    };
    ...
    out_meta->module_license.spdx_expression = OBI_IPC_BUS_DBUS1_PROVIDER_SPDX;
    ...
    out_meta->effective_license.spdx_expression = "MPL-2.0 AND (AFL-2.1 OR GPL-2.0-or-later)";
    out_meta->effective_license.summary_utf8 =
        "Effective posture includes dbus-1 dependency with conservative multi-license interpretation";
